...
const assistant_num_pins: u8 = 40; // TODO find a better place than to hardcode this here.
...
impl TestStand {
    ...
    pub fn new() -> Result<Self, TestStandInitError> {
        ...
        Self::new_with_connection(target, assistant)
    }

    /// Create a new instance of `TestStand`
    pub fn new_with_connection(target_conn: Result<Conn, NotConfiguredError>,
                               assistant_conn: Result<Assistant, NotConfiguredError>)
        -> Result<Self, TestStandInitError> {
